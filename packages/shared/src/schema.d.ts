...
export declare const participants: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "participants";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
...
export declare const insertWaitlistSchema: z.ZodObject<{
    email: z.ZodString;
...
export declare const selectWaitlistSchema: z.ZodObject<{
    email: z.ZodString;
    name: z.ZodOptional<z.ZodString>;
    profession: z.ZodOptional<z.ZodString>;
} & {
...
export declare const anonymousAuthSchema: z.ZodObject<{
...
export declare const upgradeAuthSchema: z.ZodObject<{
    email: z.ZodString;
...
export declare const loginAuthSchema: z.ZodObject<{
